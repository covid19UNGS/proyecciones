...
knitr::kable(select(cor_FallRec, - dias_hospitalizacion, - hospitalizado),caption = "Tabla 1: Fallecidos sin fecha de hospitalización con respecto a Casos")
...
knitr::kable(select(cor_FallRec, - dias_hospitalizacion, - hospitalizado),caption = "Tabla 2:  TOTAL: Fallecidos sin fecha de hospitalización con respecto a Casos")
