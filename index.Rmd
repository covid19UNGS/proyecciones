...
esProv <- estima_Re_from_df(dfCABA,"CABA",end_date = max(cor$fecha),nombre_fases = c("Cuarentena","Fase 2","Fase 3","Fase 3","ASPO","Nuevo ASPO"))
...
esProv <- estima_Re_from_df(cor_incidence_obj,"CABA Datos Abiertos MinSal",nombre_fases = c("Cuarentena","Fase 2","Fase 3","Fase 3","ASPO","Nuevo ASPO"))
...
esProv <- estima_Re_from_df(dfCABA,"Buenos Aires",end_date = max(cor$fecha),nombre_fases = c("Cuarentena","Fase 2","Fase 3","Fase 3","ASPO","Nuevo ASPO"))
...
corR <- cor_nac %>% filter(clasificacion_resumen=="Confirmado") %>% 
      ...
      do( {
          ...
          esProv <- estima_Re_from_df(cor_incidence_obj,"Datos Abiertos MinSal",nombre_fases = c("Cuarentena","Fase 2","Fase 3","Fase 3","ASPO","Nuevo ASPO"),plot = FALSE)
...
nombre_fases = c("Cuarentena","Fase 2","Fase 3","Fase 3","ASPO/DISPO","Nuevo ASPO")
...
esProv <- estima_Re_from_df(cor_incidence_obj,"Datos Abiertos MinSal",nombre_fases = c("Cuarentena","Fase 2","Fase 3","Fase 3","ASPO","Nuevo ASPO"),plot = TRUE)
