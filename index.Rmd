...
esProv <- estima_Re_from_df(dfCABA,"Buenos Aires",end_date = max(cor$fecha),fases)
...
corR <- cor_nac %>% filter(clasificacion_resumen=="Confirmado") %>% 
      ...
      do( {
          ...
          esProv <- estima_Re_from_df(cor_incidence_obj,"Datos Abiertos MinSal",fases,plot = FALSE)
...
esProv <- estima_Re_from_df(cor_incidence_obj,"Datos Abiertos MinSal",fases,plot = TRUE)
