...
* El intervalo serial posteriormente estimado por @He2020 (77 casos) con una media de 5.8 está dentro de los parametros simulados
...
* Si usamos los datos de @He2020 (77 casos) para estimar el intervalo serial (SI media de 5.8), hay 
...
La mediana del intervalo serial estimado es **mu =`r mu`** y la desviación **sigma =`r sigma`** 
...
* La linea punteada roja vertical es el primer pico de casos despues de la cuarentena que tomo para dividir 1ra fase, habria que agregar distintas fases de la cuarentena y evaluar el grado de movilidad. 
...
## Estimacion de $R_t$ y tiempo de duplicación para Tierra Del Fuego

* La linea punteada roja vertical es el primer pico de casos local para separar la 1ra fase, de 2da fase. Tambien habría que comparar con datos de movilidad. 
