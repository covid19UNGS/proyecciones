...
#
csv_fname1 <- "Data/covid_19_casos.csv"
cor_nac <- read_csv2(csv_fname1)
...
esProv <- estima_Re_from_df(cor_incidence_obj,"CABA Locales/Importados Fecha Síntomas",nombre_fases = c("Cuarentena","Fase 2","Fase 3","Fase 3"))
