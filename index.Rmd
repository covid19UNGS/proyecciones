...
ggplot(reff_df,aes(terapia,R,color=log(terapia))) + geom_point() + scale_colour_distiller(palette="YlOrRd", guide = FALSE,direction= 1) +   labs(title = " Casos COVID-19, Argentina, 2020 by @larysar")
...
esProv <- estima_Re_from_df(dfCABA,"CABA",end_date = today(),nombre_fases = c("Cuarentena","Fase 2","Fase 3","Fase 3"))
